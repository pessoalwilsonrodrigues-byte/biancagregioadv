...
const WhatsAppButton = () => {
  return (
    <motion.a
      href="https://wa.me/5543999734530"
      target="_blank"
    ...
    >
      <div className="relative">
        ...
        {/* Button */}
        <div className="relative w-16 h-16 rounded-full bg-whatsapp flex items-center justify-center shadow-lg pulse-soft cursor-pointer hover:scale-110 transition-transform">
          <svg 
            viewBox="0 0 24 24" 
            fill="currentColor" 
